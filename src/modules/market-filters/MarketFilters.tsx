      ...
      <div className='mt-4 space-y-4'>
        <div className='space-y-2'>
          ...
          <div className='space-y-1'>
            <UiCheckbox id='pizza_type_1' name='pizza_type_1' label='Традиционное' />
            <UiCheckbox id='pizza_type_2' name='pizza_type_2' label='Тонкое' />
          </div>
        </div>
        <div className='space-y-2'>
          <h4 className='text-xl font-semibold'>Размер пиццы</h4>
          <div className='space-y-1'>
            <UiCheckbox id='pizza_size_1' name='pizza_size_1' label='20 см' />
            <UiCheckbox id='pizza_size_2' name='pizza_size_2' label='30 см' />
            <UiCheckbox id='pizza_size_3' name='pizza_size_3' label='40 см' />
          </div>
        </div>
        <div className='space-y-2'>
          ...
          <div className='scrollbar max-h-96 space-y-1 overflow-y-auto'>
            {ingredients.map((ingredient, index) => (
              <UiCheckbox key={index} id={`ingredient_${index}`} name={`ingredient_${index}`} label={ingredient.name} />
            ))}
          </div>
          {showAll ? (
            <button
